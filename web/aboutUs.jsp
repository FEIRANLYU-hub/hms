        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="video-text">
                    <h2>For more hotel details, click on the video</h2><h3>(To show the effect, reposted a video on youtube, https://www.youtube.com/watch?v=WJThNmE_ehE)</h3>

                    <a href="https://www.youtube.com/watch?v=WJThNmE_ehE" class="play-btn video-popup"><img

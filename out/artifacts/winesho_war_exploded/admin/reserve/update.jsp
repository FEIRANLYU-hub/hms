    ...
    <form class="layui-form" lay-filter="update" >
        ...
        <div class="layui-form-item">
            <label  class="layui-form-label">
                <span class="x-red">*</span>Older number
            </label>
        ...
        <div class="layui-form-item">
            <label class="layui-form-label">Check-in or not</label>
            <div class="layui-input-block">
                <input type="checkbox" <c:if test="${info.state==1}">checked </c:if> name="state" lay-skin="switch" lay-filter="switchTest" lay-text="check in|reserve">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">Pay or not</label>
            <div class="layui-input-block">
                <input type="checkbox" checked="" <c:if test="${info.is_pay==1}">checked </c:if> name="isPay" lay-skin="switch" lay-filter="switchTest" lay-text="pay|outstanding expenses
">
            </div>
        </div>
        <div class="layui-form-item">

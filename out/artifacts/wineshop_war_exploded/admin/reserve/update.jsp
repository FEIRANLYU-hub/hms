...
<div class="x-body">
    <form class="layui-form" lay-filter="update" >
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="checkbox"  name="state" lay-skin="switch" lay-filter="switchTest" lay-text="check in|reserve" <c:if test="${info.state==1}">checked </c:if>>
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">Pay or not</label>
            <div class="layui-input-block">
                <input type="checkbox"  name="isPay" lay-skin="switch" lay-filter="switchTest" lay-text="pay|outstanding expenses" <c:if test="${info.is_pay==1}">checked </c:if>>
            </div>
        </div>
        <div class="layui-form-item">
            <label  class="layui-form-label">

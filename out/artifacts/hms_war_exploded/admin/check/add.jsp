...
<head>
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=e dge,chrome=1">
    ...
    <form class="layui-form">
        <div class="layui-form-item">
            <label for="L_pass" class="layui-form-label">
                <span class="x-red">*</span>Check-out remarks information
            </label>
        ...
        form.on('submit(add)', function(data){
            ...
            $.ajax({
                ...
                success:function (result) {
                    ...
                    if(result.code==0){
                        layer.alert("Check out successful", {icon: 6},function () {
                            //关闭当前frame
                            x_admin_close();
                            // 可以对父窗口进行刷新

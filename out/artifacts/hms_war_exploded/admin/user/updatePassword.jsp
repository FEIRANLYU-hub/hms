    ...
    <form class="layui-form">
        ...
        <div class="layui-form-item">
            <label for="password" class="layui-form-label">
                <span class="x-red">*</span>Enter your password
            </label>
        ...
        <div class="layui-form-item">
            <label for="password" class="layui-form-label">
                <span class="x-red">*</span>Enter again
            </label>
            <div class="layui-input-inline">
    ...
    layui.use(['form','layer'], function(){
        ...
        form.on('submit(updatePassword)', function(data){
            ...
            if(data.password!=data.password2){
                layer.msg("The two passwords you entered do not match...");
                return false;
            }
            debugger
            ...
            $.ajax({
                ...
                success:function(result){
                    if(result.code==0){
                        layer.alert("Password reset successfully", {icon: 6},function () {
                            //关闭当前frame
                            x_admin_close();
                            // 可以对父窗口进行刷新
                        ...
                        layer.msg("Sorry, password reset failed...")
                    }
                }
            })
            return false;

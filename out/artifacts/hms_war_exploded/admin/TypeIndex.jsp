...
<div class="x-body">
    ...
    <script type="text/html" id="toolbarDemo">
        ...
        <xblock>
            ...
            <button class="layui-btn" onclick="x_admin_show('Add room type','./TypeAdd.jsp',600,400)"><i class="layui-icon"></i>Add</button>
        </xblock>
        </div>
    </script>
    <table class="layui-table" lay-data="{url:'../typeInfoServlet',page:{ prev: 'previous page',next:'next page',first: 'first',last: 'last',layout: ['prev', 'page', 'next','first']},toolbar: '#toolbarDemo',id:'test'}" lay-filter="test">
        <thead>
        <tr>
            <th lay-data="{type:'checkbox'}">ID</th>
            <th lay-data="{field:'id', width:120, sort: true}">ID</th>
            <th lay-data="{field:'typeName', width:200, sort: true}">Type name</th>
            <th lay-data="{field:'price',  width: 150}">Price</th>
            <th lay-data="{field:'createTime',templet: '#dateTpl'}">Creation time</th>
            <th lay-data="{field:'createAuthor', width: 150}">Creator</th>
            <th lay-data="{fixed: 'right', width:220, align:'center', toolbar: '#barDemo'}">Operation</th>
        </tr>
        </thead>
    </table>

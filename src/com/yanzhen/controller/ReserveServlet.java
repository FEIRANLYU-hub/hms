    ...
    protected void service(HttpServletRequest req,
        ...
        switch (flag){
            ...
            case "updateStatus":
                ...
                try {
                    ReserveInfo reserveInfo = service.queryByID(Integer.parseInt(id2));
                    if("email".equals(reserveInfo.getType())){
                        SendEmail.sendRegisterEmail(reserveInfo.getRoom_id()+"",reserveInfo.getId_card(),reserveInfo.getTel());
                    }
            ...
            case "update":
                ...
                resp.setContentType("application/json;chartset=utf-8");
                String jsons2=JSON.toJSONString(R.fail("update failed..."));
                if(bs){
